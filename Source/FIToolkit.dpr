...
uses
  ...
  FIToolkit.Base.FiniteStateMachine.Consts in 'Base\FiniteStateMachine\FIToolkit.Base.FiniteStateMachine.Consts.pas',
  FIToolkit.Base.FiniteStateMachine.Exceptions in 'Base\FiniteStateMachine\FIToolkit.Base.FiniteStateMachine.Exceptions.pas',
  FIToolkit.Base.FiniteStateMachine.FSM in 'Base\FiniteStateMachine\FIToolkit.Base.FiniteStateMachine.FSM.pas',
