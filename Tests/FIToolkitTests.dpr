...
uses
  ...
  FIToolkit.Base.FiniteStateMachine.Consts in '..\Source\Base\FiniteStateMachine\FIToolkit.Base.FiniteStateMachine.Consts.pas',
  FIToolkit.Base.FiniteStateMachine.Exceptions in '..\Source\Base\FiniteStateMachine\FIToolkit.Base.FiniteStateMachine.Exceptions.pas',
  FIToolkit.Base.FiniteStateMachine.FSM in '..\Source\Base\FiniteStateMachine\FIToolkit.Base.FiniteStateMachine.FSM.pas',
  FIToolkit.Base.Types in '..\Source\Base\FIToolkit.Base.Types.pas',
  FIToolkit.Base.Utils in '..\Source\Base\FIToolkit.Base.Utils.pas',
  ...
  Test_FIToolkit.Base.FiniteStateMachine.FSM in 'Test_FIToolkit.Base.FiniteStateMachine.FSM.pas',
  Test_FIToolkit.Base.Types in 'Test_FIToolkit.Base.Types.pas',
  Test_FIToolkit.Base.Utils in 'Test_FIToolkit.Base.Utils.pas',
